...
### Overal Statistics
This dataset has an ordinal target, with discrete values from 0 to 8. There are a number of normally distributed numeric variables, all tightly cetnered around the mean, as well as three ordinal variables (**STARS** and **AcidIndex** and **LabelAppeal**). 
...
Instead, the variables with high correlation are **STARS** and **TARGET** (0.56). There is some correlation between and **LabelAppeal** and **STARS** (0.33) and **LabelAppeak** and **TARGET** (0.36), as well asa moderate negative correation between **AcidIndex** and **Target** (-0.24). Other variables are largely uncorrelated.
